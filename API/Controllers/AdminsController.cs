...
namespace Microservice.Controllers
{
    ...
    public class AdminsController : ControllerBase
    {
        ...
        public AdminsController(CabinetContext context)
        {
            _context = context;
        }
        ...
        {
            var user = await _context.Admins.FirstOrDefaultAsync(a => a.Email == admin.Email);
            if (user == null)
            {
                return NotFound();
            }
        ...
        {
            var admin = await _context.Admins.FirstOrDefaultAsync(p => p.Email == user.Email);
            ...
            if (!BCrypt.Net.BCrypt.Verify(user.Password, admin.Password))
            {
                return NotFound();
            }
